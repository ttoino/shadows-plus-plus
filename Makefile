...
SRC = main.cpp CBoxShadowsDecoration.cpp CBoxShadowsPassElement.cpp shadowsLua.cpp
...
test:
	$(CXX) -std=c++2b -I. $(LDFLAGS) tests/shadowsLua.cpp -o shadows-plus-plus-tests `pkg-config --cflags hyprutils gtest` `pkg-config --libs hyprutils gtest` -lgtest_main
